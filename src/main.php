...
<main>
    <?php
        ...
        while($row = $result->fetch(PDO::FETCH_ASSOC)){
            ?>
          <tr>
        <td><?php echo $row["Projekto_id"]; ?></td>&nbsp;
        <td><?php echo $row["Pavadinimas"]; ?></td>&nbsp;
        <td><?php echo $row["Aprasymas"]; ?></td>&nbsp;
        <td><?php echo $row["Busena"]; ?></td>&nbsp;
        <td><?php echo $row["Sukurimo_data"]; ?></td>&nbsp;
        <td><?php echo $row["Visos_uzduotys"]; ?></td>&nbsp;
        <td><?php echo $row["Neatliktos_uzduotys"]; ?></td>&nbsp;
...
<!--
            echo "<tr>
            <td>".$row['Projekto_id']."</td>
            <td>".$row['Pavadinimas']."</td>
            <td>".$row['Aprasymas']."</td>
            <td>".$row['Busena']."</td>
            <td>".$row['Sukurimo_data']."</td>
            <td>".$row['Visos_uzduotys']."</td>
            <td>".$row['Neatliktos_uzduotys']."</td>
            </tr>";
-->
