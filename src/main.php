...
<main>
	<?php
		...
		while($row = $result->fetch(PDO::FETCH_ASSOC)){    
		  ...
		  </div></td><td class='td-spacing'><button class=\"button\"><i class='far fa-edit'></i></button><button class=\"button\"><i class='far fa-trash-alt'></i></button><button class=\"button\"><i class='fas fa-archive'></i></button><button class=\"button\"><i class='fas fa-arrow-down'></i></button></td><td><button class=\"button\" id='create-button'><i class='fas fa-plus-circle' id='plus-button'></i></button></td></tr>";
			break;
			}
