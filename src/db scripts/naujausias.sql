...
--
-- Host: 127.0.0.1
-- Generation Time: 2021 m. Geg 21 d. 12:11
...
(332096020, 'Create2', '', 'In Progress', '2021-05-21');
...
(2, 'Komandos narys', 'Negali istrinti projektu');
...
INSERT INTO `uzduotys` (`Uzduoties_id`, `Pavadinimas`, `Aprasymas`, `Prioritetas`, `Busena`, `Sukurimo_data`, `Naujinimo_data`, `Eiles_nr`, `Projekto_id`) VALUES
(641361970, 'Double clickity click', '', 'Low', 'To do', '2021-05-21', '2021-05-21', 86, 332096020);
...
('naujas@naujas.lt', 'Naujas123', 'Mike', 'Los Angelas', 2),
('abc@abc.com', 'Abcdefg1', 'Lukas', 'Vukas', 3),
...
--
ALTER TABLE `uzduotys`
  MODIFY `Eiles_nr` bigint(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
